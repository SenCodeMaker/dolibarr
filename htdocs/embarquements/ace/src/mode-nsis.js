...
var NSISHighlightRules = function() {
    ...
    this.$rules = {
        start: [{
            ...
            regex: /^\s*!(?:inclusions|addinclusionsdir|addplugindir|appendfile|cd|delfile|echo|error|execute|packhdr|pragma|finalize|getdllversion|gettlbversion|system|tempfile|warning|verbose|define|undef|insertmacro|macro|macroend|makensis|searchparse|searchreplace)\b/,
            ...
            token: "text",
            regex: /(?:!inclusions|!insertmacro)\b/
        }]
    };
