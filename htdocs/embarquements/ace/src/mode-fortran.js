...
var FortranHighlightRules = function() {
    ...
    var keywords = (
        ...
        "if|implicit|in|inclusions|inout|intent|module|none|only|out|print|program|return|"+
    ...
    this.$rules = {
        "start" : [ {
            ...
            regex : "#\\s*(?:inclusions|import|define|undef|inclusions|IMPORT|DEFINE|UNDEF)\\b"
        }, {
