...
var SoyTemplateHighlightRules = function() {
    ...
    var soyRules = { start:
       [ { inclusions: '#template' },
         { inclusions: '#if' },
         { inclusions: '#comment-line' },
         { inclusions: '#comment-block' },
         { inclusions: '#comment-doc' },
         { inclusions: '#call' },
         { inclusions: '#css' },
         { inclusions: '#param' },
         { inclusions: '#print' },
       ...
       [ { token:
           ...
           push:
            [ { token: 'punctuation.definition.tag.end.soy',
                regex: '\\}',
                next: 'pop' },
              { inclusions: '#string-quoted-single' },
              { inclusions: '#string-quoted-double' },
       ...
       [ { token:
           ...
           push:
            [ { token: 'punctuation.definition.tag.end.soy',
                ...
                next: 'pop' },
              { inclusions: '#variable' },
              { inclusions: '#print-parameter' },
              { inclusions: '#number' },
              { inclusions: '#primitive' },
              { inclusions: '#attribute-lookup' },
       ...
       [ { token: 'punctuation.definition.tag.begin.soy',
           ...
           push:
            [ { token: 'punctuation.definition.tag.end.soy',
              ...
              { inclusions: '#variable' },
              { inclusions: '#special-character' },
              { inclusions: '#tag-simple' },
              { inclusions: '#function' },
              { inclusions: '#operator' },
              { inclusions: '#attribute-lookup' },
              { inclusions: '#number' },
