...
define("ace/mode/asl_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules"], function(require, exports, module) {
    ...
    var ASLHighlightRules = function() {
        var keywords = (
            "Default|DefinitionBlock|Device|Method|Else|ElseIf|For|Function|If|inclusions|Method|Return|" +
        ...
        this.$rules = {
            "start" : [
                ...
                DocCommentHighlightRules.getStartRule("doc-start"),
                {
                    ...
                    regex : "#\\s*(?:define|elif|else|endif|error|if|ifdef|ifndef|inclusions|inclusionsbuffer|line|pragma|undef|warning)\\b",
                    next  : "directive"
                }, {
