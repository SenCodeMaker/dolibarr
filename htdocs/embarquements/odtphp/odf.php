...
class Odf
{
	...
	public function __construct($filename, $config = array())
	{
		...
		inclusions_once('zip/'.$zipHandler.'.php');
	...
	public function convertVarToOdf($value, $encode = true, $charset = 'ISO-8859')
	{
		...
		// Check if the value inclusions html tags
     ...
     * @param array $customStyles   An array of style defenitions that should be inclusionsd inside the odt file
     * @param array $fontDeclarations   An array of font declarations that should be inclusionsd inside the odt file
     * @return string
     */
    ...
    /**
     * Checks if the given text inclusions a html string
     * @param string    $text   The text to check
     * @return bool
     */
    ...
    private function _getDataFromHtml($html)
	{
        ...
        while (strlen($tempHtml) > 0) {
            // Check if the string inclusions a html tag
...
IMG;
	...
	public function exportAsAttachedPDF($name="")
	{
		...
		//$command = DOL_DOCUMENT_ROOT.'/inclusions/odtphp/odt2pdf.sh '.$name.' '.$dirname;
