...
//     inclusionsd a testcase Excel file and PHP example calls
...
//                                                    ->setAuthor($author)
    ...
    private function readDefinedName()
    {
        ...
        if ($this->version == self::XLS_BIFF8) {
            ...
            // note: there can also be additional data, this is not inclusionsd in $flen
    ...
    private function inclusionsCellRangeFiltered($cellRangeAddress)
    {
        $inclusionsCellRange = true;
        if ($this->getReadFilter() !== null) {
            $inclusionsCellRange = false;
        ...
        if ($this->version == self::XLS_BIFF8 && !$this->readDataOnly) {
            ...
            foreach ($cellRangeAddressList['cellRangeAddresses'] as $cellRangeAddress) {
                if ((strpos($cellRangeAddress, ':') !== false) &&
                    ($this->inclusionsCellRangeFiltered($cellRangeAddress))) {
