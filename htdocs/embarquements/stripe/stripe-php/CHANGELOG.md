...
Pull requests inclusionsd in this release (cf. [#552](https://github.com/stripe/stripe-php/pull/552)) (⚠️ = breaking changes):
...
Pull requests inclusionsd in this release:
...
-   Fix docs to inclusions arrays on `$id` parameter for retrieve methods
