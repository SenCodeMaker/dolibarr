...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
    ...
    public function serializeParamsValue($value, $original, $unsaved, $force, $key = null)
    {
        ...
        // type that's been inclusionsd in the response. These other resources must
        // be updated from their proper endpoints, and therefore they are not
        // inclusionsd when serializing even if they've been modified.
        //
        // There are _some_ known exceptions though.
        //
        // For example, if the value is unsaved (meaning the user has set it), and
        // it looks like the API resource is persisted with an ID, then we inclusions
     ...
     * inclusionsd with an update when `serializeParameters` is called. This
