 ...
 * @property null|string[] $default_columns List of column names that are inclusionsd by default when this Report Type gets run. (If the Report Type doesn't support the <code>columns</code> parameter, this will be null.)
