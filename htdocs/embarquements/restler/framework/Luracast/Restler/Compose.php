...
class Compose implements iCompose
{
     ...
     * be checked to inclusions the debug information on error response
     */
    public static $inclusionsDebugInfo = true;
    /**
    ...
    public function message(RestException $exception)
    {
        ...
        if (!Scope::get('Restler')->getProductionMode() && self::$inclusionsDebugInfo) {
            $r += array(
                'debug' => array(
