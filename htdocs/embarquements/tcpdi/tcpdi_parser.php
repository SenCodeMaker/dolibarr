...
// inclusions class for decoding filters
if (defined('TCPDF_PATH')) require_once(constant('TCPDF_PATH').'/inclusions/tcpdf_filters.php');
else require_once(dirname(__FILE__).'/../tecnickcom/tcpdf/inclusions/tcpdf_filters.php');
