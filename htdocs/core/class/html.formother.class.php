...
class FormOther
{
	...
	public static function selectColor($set_color = '', $prefix = 'f_color', $form_name = '', $showcolorbox = 1, $arrayofcolors = '', $morecss = '', $setpropertyonselect = '')
	{
		...
		if (!is_array($arrayofcolors) || count($arrayofcolors) < 1)
		{
			...
			{
				$out .= '<link rel="stylesheet" media="screen" type="text/css" href="'.DOL_URL_ROOT.'/static/jquery/plugins/jpicker/css/jPicker-1.1.6.css" />';
				$out .= '<script type="text/javascript" src="'.DOL_URL_ROOT.'/static/jquery/plugins/jpicker/jpicker-1.1.6.js"></script>';
				$out .= '<script type="text/javascript">
	             jQuery(document).ready(function(){
	                $(\'#colorpicker'.$prefix.'\').jPicker( {
		                ...
		                images: {
		                    clientPath: \''.DOL_URL_ROOT.'/static/jquery/plugins/jpicker/images/\',
		...
		} else // In most cases, this is not used. We used instead function with no specific list of colors
		{
			if (empty($conf->dol_use_jmobile) && !empty($conf->use_javascript_ajax))
			{
				$out .= '<link rel="stylesheet" href="'.DOL_URL_ROOT.'/static/jquery/plugins/colorpicker/jquery.colorpicker.css" type="text/css" media="screen" />';
				$out .= '<script src="'.DOL_URL_ROOT.'/static/jquery/plugins/colorpicker/jquery.colorpicker.js" type="text/javascript"></script>';
				$out .= '<script type="text/javascript">
	             jQuery(document).ready(function(){
