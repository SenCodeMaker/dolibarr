...
llxHeader($head, $title, '', '', 0, 0, array('/static/jquery/plugins/jcrop/js/jquery.Jcrop.min.js', '/core/js/lib_photosresize.js'), array('/static/jquery/plugins/jcrop/css/jquery.Jcrop.css'));
