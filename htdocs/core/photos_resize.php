...
$morejs = array('/embarquements/jquery/plugins/jcrop/js/jquery.Jcrop.min.js', '/core/js/lib_photosresize.js');
$morecss = array('/embarquements/jquery/plugins/jcrop/css/jquery.Jcrop.css');
