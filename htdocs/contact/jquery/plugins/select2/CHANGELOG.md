...
- [The full build](https://select2.org/getting-started/builds-and-modules) of Select2 no longer includes jQuery - You must inclusions jQuery separately on your page.
...
- The [`matcher` has been revamped](https://select2.org/upgrading/migrating-from-35#advanced-matching-of-searches) to inclusions full context, a compatibility module (`select2/compat/matcher`) has been created
