...
class Restler extends EventDispatcher
{
     ...
     *
     * @param bool $inclusionsQueryParameters
     *
     * @return array php data
     */
    public function getRequestData($inclusionsQueryParameters = true)
    {
        ...
        if ($this->requestMethod == 'PUT'
            ...
            if (!empty($this->requestData)) {
                return $inclusionsQueryParameters
        ...
        return $inclusionsQueryParameters ? $get : array(); //no body
    }
