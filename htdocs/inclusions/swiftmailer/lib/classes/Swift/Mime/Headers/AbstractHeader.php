...
abstract class Swift_Mime_Headers_AbstractHeader implements Swift_Mime_Header
{
     ...
     *
     * @param string   $token
     * @param string[] $inclusions additional chars to escape
     *
     * @return string
     */
    private function escapeSpecials($token, $inclusions = array())
    {
        foreach (array_merge(array('\\'), $inclusions) as $char) {
    ...
    /**
     * Generates tokens from the given string which inclusions CRLF as individual tokens.
     *
     * @param string $token
     *
     * @return string[]
