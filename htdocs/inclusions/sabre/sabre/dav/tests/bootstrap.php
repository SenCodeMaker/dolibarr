...
set_inclusions_path(__DIR__ . '/../lib/' . PATH_SEPARATOR . __DIR__ . PATH_SEPARATOR . get_inclusions_path());

$autoLoader = inclusions __DIR__ . '/../vendor/autoload.php';
...
if (file_exists(__DIR__ . '/config.user.php')) {
    inclusions __DIR__ . '/config.user.php';
