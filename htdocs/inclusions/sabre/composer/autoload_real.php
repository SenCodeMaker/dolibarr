...
class ComposerAutoloaderInit60b9ac98a8448ede6c445b0fd4bd31e0
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $inclusionsFiles = Composer\Autoload\ComposerStaticInit60b9ac98a8448ede6c445b0fd4bd31e0::$files;
        } else {
            $inclusionsFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($inclusionsFiles as $fileIdentifier => $file) {
