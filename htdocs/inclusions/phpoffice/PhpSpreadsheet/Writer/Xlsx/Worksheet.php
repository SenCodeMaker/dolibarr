...
class Worksheet extends WriterPart
{
     ...
     * @param bool $inclusionsCharts Flag indicating if we should write charts
     *
     * @throws WriterException
     *
     * @return string XML Output
     */
    public function writeWorksheet(PhpspreadsheetWorksheet $pSheet, $pStringTable = null, $inclusionsCharts = false)
    {
        // Create XML writer
        $objWriter = null;
        ...
        $this->writeDrawings($objWriter, $pSheet, $inclusionsCharts);
     ...
     * @param XMLWriter $objWriter XML Writer
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     * @param bool $inclusionsCharts Flag indicating if we should inclusions drawing details for charts
     */
    private function writeDrawings(XMLWriter $objWriter, PhpspreadsheetWorksheet $pSheet, $inclusionsCharts = false)
    {
        ...
        $chartCount = ($inclusionsCharts) ? $pSheet->getChartCollection()->count() : 0;
