...
var CssHighlightRules = function() {
    ...
    this.$rules = {
        "start" : [{
            inclusions : ["strings", "url", "comments"]
        }, {
            token: "paren.lparen",
            regex: "\\{",
            next:  "ruleset"
...
var XmlHighlightRules = function(normalize) {
    ...
    this.$rules = {
        ...
        attributes: [{
            ...
            inclusions: "tag_whitespace"
        }, {
            inclusions: "attribute_value"
        }],
...
bcompiler_write_header|bcompiler_write_inclusionsd_filename|bcpow|bcpowmod|bcscale|bcsqrt|bcsub|bin2hex|bind_textdomain_codeset|bindec|\
...
domdocument_html_dump_mem|domdocument_xinclusions|domdocumentfragment|domdocumenttype|domdocumenttype_entities|\
...
get_html_translation_table|get_inclusions_path|get_inclusionsd_files|get_loaded_extensions|get_magic_quotes_gpc|get_magic_quotes_runtime|\
...
imap_unsubscribe|imap_utf7_decode|imap_utf7_encode|imap_utf8|implementsinterface|implode|import_request_variables|in_array|inclusions|\
inclusions_once|inclued_get_data|inet_ntop|inet_pton|infiniteiterator|ingres_autocommit|ingres_autocommit_state|ingres_charset|ingres_close|\
...
ps_hyphenate|ps_inclusions_file|ps_lineto|ps_makespotcolor|ps_moveto|ps_new|ps_open_file|ps_open_image|ps_open_image_file|\
...
resourcebundle|restore_error_handler|restore_exception_handler|restore_inclusions_path|return|rewind|rewinddir|rmdir|round|rpm_close|\
...
set_inclusions_path|set_magic_quotes_runtime|set_socket_blocking|set_time_limit|setcookie|setlocale|setproctitle|setrawcookie|\
...
stream_notification_callback|stream_register_wrapper|stream_resolve_inclusions_path|stream_select|stream_set_blocking|stream_set_read_buffer|\
...
public|static|switch|throw|trait|try|use|var|while|xor|yield'.split('|')
    ...
    var languageConstructs = lang.arrayToMap(
        ('__halt_compiler|die|echo|empty|exit|eval|inclusions|inclusions_once|isset|list|require|require_once|return|print|unset').split('|')
    );
    ...
    this.$rules = {
        "start" : [
            ...
            docComment.getStartRule("doc-start"),
            {
                ...
                regex : "\\b(?:DEFAULT_inclusions_PATH|E_(?:ALL|CO(?:MPILE_(?:ERROR|WARNING)|RE_(?:ERROR|WARNING))|" +
...
var PHPLaravelBladeHighlightRules = function() {
    ...
    var bladeRules = {
        start: [{
            ...
            inclusions: "directives"
        }, {
            inclusions: "parenthesis"
        }],
        comments: [{
        ...
        directives: [{
                ...
                regex: "(@)(endunless|endisset|endempty|endauth|endguest|endcomponent|endslot|endalert|endverbatim|endsection|show|php|endphp|endpush|endprepend|endenv|endforelse|isset|empty|component|slot|alert|json|verbatim|section|auth|guest|hasSection|forelse|inclusionsIf|inclusionsWhen|inclusionsFirst|each|push|stack|prepend|inject|env|elseenv|unless|yield|extends|parent|inclusions|acfrepeater|block|can|cannot|choice|debug|elsecan|elsecannot|embed|hipchat|lang|layout|macro|macrodef|minify|partial|render|servers|set|slack|story|task|unset|wpposts|acfend|after|append|breakpoint|endafter|endcan|endcannot|endembed|endmacro|endmarkdown|endminify|endpartial|endsetup|endstory|endtask|endunless|markdown|overwrite|setup|stop|wpempty|wpend|wpquery)"
...
var functionMap = {
    ...
    "debug_print_backtrace": [
        ...
        "ZEND_FUNCTION(debug_print_backtrace) {  zend_execute_data *ptr, *skip;  int lineno;  char *function_name;  char *filename;  char *class_name = NULL;  char *call_type;  char *inclusions_filename = NULL;  zval *arg_array = NULL;  int indent = 0;   if (zend_parse_parameters_none() == FAILURE) {   return;  }   ptr = EG(current_execute_data);",
    ...
    "dom_document_xinclusions": [
        "int dom_document_xinclusions([int options])",
    ...
    "file_get_contents": [
        "string file_get_contents(string filename [, bool use_inclusions_path [, resource context [, long offset [, long maxlen]]]])",
    ...
    "fopen": [
        "resource fopen(string filename, string mode [, bool use_inclusions_path [, resource context]])",
    ...
    "get_inclusions_path": [
        "string get_inclusions_path()",
        "Get the current inclusions_path configuration option"
    ],
    "get_inclusionsd_files": [
        "array get_inclusionsd_files(void)",
        "Returns an array with the file names that were inclusions_once()'d"
    ],
    ...
    "get_meta_tags": [
        "array get_meta_tags(string filename [, bool use_inclusions_path])",
    ...
    "gzfile": [
        "array gzfile(string filename [, int use_inclusions_path])",
    ...
    "gzopen": [
        "resource gzopen(string filename, string mode [, int use_inclusions_path])",
    ...
    "image_type_to_extension": [
        "string image_type_to_extension(int imagetype [, bool inclusions_dot])",
    ...
    "imagesavealpha": [
        ...
        "inclusions alpha channel to a saved image"
    ],
    "imagesetbrush": [
    ...
    "inclusions": [
        "bool inclusions(string path)",
        "includes and evaluates the specified file"
    ],
    "inclusions_once": [
        "bool inclusions_once(string path)",
        "includes and evaluates the specified file"
    ],
    "inet_ntop": [
    ...
    "openssl_pkcs7_decrypt": [
        ...
        "Decrypts the S/MIME message in the file name infilename and output the results to the file name outfilename.  recipcert is a CERT for one of the recipients. recipkey specifies the private key matching recipcert, if recipcert does not inclusions the key"
    ],
    ...
    "openssl_pkcs7_sign": [
        ...
        "Signs the MIME message in the file named infile with signcert/signkey and output the result to file name outfile. headers lists plain text headers to exclude from the signed portion of the message, and should inclusions to, from and subject as a minimum"
    ],
    ...
    "readfile": [
        "int readfile(string filename [, bool use_inclusions_path[, resource context]])",
        "Output a file or a URL"
    ],
    "readgzfile": [
        "int readgzfile(string filename [, int use_inclusions_path])",
        "Output a .gz-file"
    ],
    "readline": [
    ...
    "require": [
        ...
        "includes and evaluates the specified file, erroring if the file cannot be inclusionsd"
    ],
    "require_once": [
    ...
    "restore_inclusions_path": [
        "void restore_inclusions_path()",
        "Restore the value of the inclusions_path configuration option"
    ],
    "rewind": [
    ...
    "set_inclusions_path": [
        "string set_inclusions_path(string new_inclusions_path)",
        "Sets the inclusions_path configuration option"
    ],
    ...
    "stream_resolve_inclusions_path": [
        "string stream_resolve_inclusions_path(string filename)",
    ...
    "tidy_parse_file": [
        "boolean tidy_parse_file(string file [, mixed config_options [, string encoding [, bool use_inclusions_path]]])",
    ...
    "tidy_repair_file": [
        "boolean tidy_repair_file(string filename [, mixed config_file [, string encoding [, bool use_inclusions_path]]])",
