...
var ForthHighlightRules = function() {
    ...
    this.$rules = { start: [ { inclusions: '#forth' } ],
      '#comment':
      ...
      '#string':
       [ { token: 'string.quoted.double.forth',
         ...
         { token: 'string.unquoted.forth',
           regex: '(?:inclusions|NEEDS|REQUIRE|USE)[ ]\\S+(?=\\s|$)',
           caseInsensitive: true}],
      '#variable':
      ...
      '#word':
       [ { token: 'keyword.control.immediate.forth',
         ...
         { token: 'keyword.other.non-immediate.forth',
           regex: '(?:^|\\s)(?:\'|<IS>|<TO>|CHAR|END-STRUCT|inclusions[D]?|LOAD|NEEDS|REQUIRE[D]?|REVISION|SEE|STRUCT|THRU|USE)(?=\\s|$)',
           caseInsensitive: true},
