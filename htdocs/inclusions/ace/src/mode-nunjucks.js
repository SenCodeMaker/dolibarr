...
var NunjucksHighlightRules = function() {
    ...
    this.addRules({
        ...
        "statement": [{
            ...
            regex: /\b(block|endblock|extends|endif|elif|for|endfor|asyncEach|endeach|inclusions|asyncAll|endall|macro|endmacro|set|endset|ignore missing|as|from|raw|verbatim|filter|endfilter)\b/
        },
            {inclusions: "expression"}
        ],
        "expression": [{
