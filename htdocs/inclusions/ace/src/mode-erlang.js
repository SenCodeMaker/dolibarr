...
var ErlangHighlightRules = function() {
    ...
    this.$rules = { start:
       [ { inclusions: '#module-directive' },
         { inclusions: '#import-export-directive' },
         { inclusions: '#behaviour-directive' },
         { inclusions: '#record-directive' },
         { inclusions: '#define-directive' },
         { inclusions: '#macro-directive' },
         { inclusions: '#directive' },
         { inclusions: '#function' },
         { inclusions: '#everything-else' } ],
      '#atom':
           ...
           push:
            [ { token: 'punctuation.definition.binary.end.erlang',
              ...
              { token:
                ...
                regex: '(,)|(:)' },
              { inclusions: '#internal-type-specifiers' },
              { inclusions: '#everything-else' },
      ...
      '#everything-else':
       [ { inclusions: '#comment' },
         { inclusions: '#record-usage' },
         { inclusions: '#macro-usage' },
         { inclusions: '#expression' },
         { inclusions: '#keyword' },
         { inclusions: '#textual-operator' },
         { inclusions: '#function-call' },
         { inclusions: '#tuple' },
         { inclusions: '#list' },
         { inclusions: '#binary' },
         { inclusions: '#parenthesized-expression' },
         { inclusions: '#character' },
         { inclusions: '#number' },
         { inclusions: '#atom' },
         { inclusions: '#string' },
         { inclusions: '#symbolic-operator' },
         { inclusions: '#variable' } ],
      '#expression':
       [ { token: 'keyword.control.if.erlang',
           ...
           push:
            [ { token: 'keyword.control.end.erlang',
                regex: '\\bend\\b',
                next: 'pop' },
              { inclusions: '#internal-expression-punctuation' },
              { inclusions: '#everything-else' },
              ...
              { token: 'text',
                ...
                push:
                 [ { token: 'punctuation.separator.clauses.erlang',
                     regex: ';|(?=\\bend\\b)',
                     next: 'pop' },
                   { inclusions: '#internal-function-parts' } ] },
              { inclusions: '#everything-else' },
       ...
       [ { token:
           ...
           push:
            [ { token:
                ...
                regex: '(\\))(\\s*)(\\.)',
                next: 'pop' },
              { inclusions: '#internal-function-list' },
       ...
       [ { token:
           ...
           push:
            [ { token:
                ...
                regex: '(\\})(\\s*)(\\))(\\s*)(\\.)',
                next: 'pop' },
              { inclusions: '#internal-record-body' },
