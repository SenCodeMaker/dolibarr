...
var ValaHighlightRules = function() {
    ...
    this.$rules = { start:
       [ { token:
         ...
         { inclusions: '#code' } ],
      '#all-types':
       [ { inclusions: '#primitive-arrays' },
         { inclusions: '#primitive-types' },
         { inclusions: '#object-types' } ],
      '#annotations':
       [ { token:
              ...
              { token: 'storage.modifier.extends.vala',
                ...
                push:
                 [ { token: 'meta.definition.class.inherited.classes.vala',
                     regex: '(?={|,)',
                     next: 'pop' },
                   { inclusions: '#object-types-inherited' },
                   { inclusions: '#comments' },
      ...
      '#code':
       [ { inclusions: '#comments' },
         ...
         { inclusions: '#parens' },
         { inclusions: '#constants-and-special-vars' },
         { inclusions: '#anonymous-classes-and-new' },
         { inclusions: '#keywords' },
         { inclusions: '#storage-modifiers' },
         { inclusions: '#strings' },
      ...
      '#comments':
       [ { token: 'punctuation.definition.comment.vala',
           regex: '/\\*\\*/' },
         { inclusions: 'text.html.javadoc' },
         { inclusions: '#comments-inline' } ],
      '#comments-inline':
       [ { token: 'punctuation.definition.comment.vala',
           regex: '/\\*',
           push:
