...
var SPARQLHighlightRules = function() {
    ...
    this.$rules = {
        start: [{
            ...
            inclusions: "#string-language-suffixes"
        }, {
            inclusions: "#string-datatype-suffixes"
        }, {
            inclusions: "#logic-operators"
        }, {
            inclusions: "#relative-urls"
        }, {
            inclusions: "#xml-schema-types"
        }, {
            inclusions: "#rdf-schema-types"
        }, {
            inclusions: "#owl-types"
        }, {
            inclusions: "#qnames"
        }, {
            inclusions: "#keywords"
        }, {
            inclusions: "#built-in-functions"
        }, {
            inclusions: "#variables"
        }, {
            inclusions: "#boolean-literal"
        }, {
            inclusions: "#punctuation-operators"
        }],
        "#boolean-literal": [{
