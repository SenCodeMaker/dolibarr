...
var MarkdownHighlightRules = function() {
    ...
    this.addRules({
        ...
        "listblock" : [ { // Lists only escape on completely blank lines.
            ...
            inclusions : "basic", noEscape: true
        },
        codeBlockStartRule,
        {
...
var ScssHighlightRules = function() {
    ...
    var keywords = lang.arrayToMap(
        ("@mixin|@extend|@inclusions|@import|@media|@debug|@warn|@if|@for|@each|@while|@else|@font-face|@-webkit-keyframes|if|and|!default|module|def|end|declare").split("|")
    );
...
var RubyHighlightRules = function() {
    ...
    var builtinFunctions = (
        ...
        "gsub!|get_via_redirect|host!|https?|https!|inclusions|Integer|lambda|link_to|" +
        "link_to_unless_current|link_to_function|link_to_remote|load|local_variables|loop|open|open_session|" +
        "p|print|printf|proc|putc|puts|post_via_redirect|put_via_redirect|raise|rand|" +
        "raw|readline|readlines|redirect?|request_via_redirect|require|scan|select|" +
        "set_trace_func|sleep|split|sprintf|srand|String|stylesheet_link_tag|syscall|system|sub|sub!|test|" +
        "throw|trace_var|trap|untrace_var|atan2|cos|exp|frexp|ldexp|log|log10|sin|sqrt|tan|" +
        "render|javascript_inclusions_tag|csrf_meta_tag|label_tag|text_field_tag|submit_tag|check_box_tag|" +
