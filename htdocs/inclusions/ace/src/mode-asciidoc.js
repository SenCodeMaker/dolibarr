...
var AsciidocHighlightRules = function() {
    ...
    for (var state in this.$rules) {
        ...
        for (var i = stateRules.length; i--; ) {
            ...
            if (rule.inclusions || typeof rule == "string") {
                var args = [i, 1].concat(this.$rules[rule.inclusions || rule]);
                if (rule.noEscape) {
