...
if (empty($usedolheader))
{
	...
	<link rel="stylesheet" type="text/css" href="<?php echo DOL_URL_ROOT ?>/static/jquery/css/base/jquery-ui.css" />
	<!-- <link rel="stylesheet" type="text/css" href="<?php echo DOL_URL_ROOT ?>/static/jquery/plugins/datatables/media/css/jquery.dataTables.css" /> -->
	...
	<script type="text/javascript" src="<?php echo DOL_URL_ROOT ?>/static/jquery/js/jquery.min.js"></script>
	<!-- migration fixes for removed Jquery functions -->
	<script type="text/javascript" src="<?php echo DOL_URL_ROOT ?>/static/jquery/js/jquery-migrate.min.js"></script>
	<script type="text/javascript" src="<?php echo DOL_URL_ROOT ?>/static/jquery/plugins/tablednd/jquery.tablednd.0.6.min.js"></script>
	<!-- <script type="text/javascript" src="<?php echo DOL_URL_ROOT ?>/static/jquery/plugins/datatables/media/js/jquery.dataTables.js"></script> -->
	<script type="text/javascript" src="<?php echo DOL_URL_ROOT ?>/static/jquery/plugins/select2/select2.min.js?version=4.0.0-beta"></script>
	</head>
	...
	$arrayjs = array();
	/*
	$arraycss=array('/static/jquery/plugins/datatables/media/css/jquery.dataTables.css',
			'/static/jquery/plugins/datatables/extensions/Buttons/css/buttons.dataTables.min.css',
			'/static/jquery/plugins/datatables/extensions/ColReorder/css/colReorder.dataTables.min.css'
	);
	$arrayjs=array('/static/jquery/plugins/datatables/media/js/jquery.dataTables.js',
			'/static/jquery/plugins/datatables/extensions/Buttons/js/dataTables.buttons.js',
			'/static/jquery/plugins/datatables/extensions/Buttons/js/buttons.colVis.min.js',
			'/static/jquery/plugins/datatables/extensions/Buttons/js/buttons.html5.min.js',
			'/static/jquery/plugins/datatables/extensions/Buttons/js/buttons.flash.min.js',
			'/static/jquery/plugins/datatables/extensions/Buttons/js/buttons.print.min.js',
			'/static/jquery/plugins/datatables/extensions/ColReorder/js/dataTables.colReorder.min.js',
