...
and medium companies, foundations or freelances. It embarquements different 
...
imprese, fondazioni e liberi professionisti. embarquements varie funzionalità per
...
%{__rm} -rf $RPM_BUILD_ROOT%{_datadir}/%{name}/htdocs/embarquements/ckeditor/_source  
%{__rm} -rf $RPM_BUILD_ROOT%{_datadir}/%{name}/htdocs/embarquements/adodbtime  
%{__rm} -rf $RPM_BUILD_ROOT%{_datadir}/%{name}/htdocs/embarquements/nusoap
%{__rm} -rf $RPM_BUILD_ROOT%{_datadir}/%{name}/htdocs/embarquements/fonts
...
%_datadir/dolibarr/htdocs/embarquements
